...
<!-- Requirements: please go through this checklist before opening a new issue -->
  - [ ] Review the documentation: https://github.com/gaetanozappi/react-native-circle
  - [ ] Search for existing issues (including closed issues): https://github.com/gaetanozappi/react-native-circle/issues

<!-- Describe your environment (OS, target platform, react-native-circle version etc.) -->
## Environment
